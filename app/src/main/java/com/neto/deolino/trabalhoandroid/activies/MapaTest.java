...
/**
 * Created by deolino on 26/11/16.
 */
public class MapaTest extends ActionBarActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location != null) {
            ...
            new AlertDialog.Builder(MapaTest.this)
...
//                l.setLatitude(-4.9781834);
//                l.setLongitude(-39.0560326);
